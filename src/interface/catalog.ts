...
export const tools={
  ...
  runtime_task_resume:{schema:z.object({task_id:id,expected_recovery_generation:z.number().int().nonnegative()}).strict(),...notImplemented},
  runtime_recovery_status:{schema:empty,implemented:true,readOnly:true},
  runtime_recovery_prepare:{schema:task,...notImplemented},
