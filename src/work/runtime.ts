...
import {type WorkMode,type WorkProposal,validateWorkProposal,workAnswerSchema,workDefineSchema,workListSchema,workPauseSchema,workProposalSchema,workStartSchema,workStatusSchema} from './contracts.js';
